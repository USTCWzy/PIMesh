...
class PatchEmbed(nn.Module):
    ...
    def forward(self, x):
        ...
        assert (W == self.img_size[1]), f"Input image Height ({W}) Doesn't match model ({self.img_size[1]})."
...
class PositionEmbed(nn.Module):
    def __init__(self, num_patches, d_model=768, num_tokens=0):
        super().__init__()
...
if __name__ == '__main__':
    patchembed = PositionEmbed(d_model=768, num_patches=196, num_tokens=1)()
