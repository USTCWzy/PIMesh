...
class Regressor(nn.Module):
    def __init__(self, camera, bed_depth, feature_len, smpl_mean_params=SMPL_MEAN_PARAMS):
        ...
        self.smpl = smplx.create('/workspace/wzy1999/3d_pose_estimation/SMPLifyIBC/data/models', model_type='smpl')
        ...
        self.camera = camera
        self.bed_depth = torch.tensor([0, 0, bed_depth])
    ...
    def forward(self, x, init_pose=None, init_shape=None, init_trans=None, n_iter=3):
        ...
        # pred_keypoints_2d = self.camera(pred_joints + self.bed_depth)
        pred_keypoints_2d = pred_joints[:, :29, :2]
